...
Books in the main living area:
	...
	- following this logic of “Magic for beginners” the logic checks out having Eve possess the most magical strength  (Bright red cloak) then Luminyan with adept levels of magic (Yellow cloak) then Laschka using minimal levels of magic (Blue cloak) then finally Karam with absolutely no magic (Black cloak)
